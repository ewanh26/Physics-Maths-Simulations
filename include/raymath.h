...
RMAPI Vector4 Vector4Transform(Vector4 v, Matrix mat)
{
    Vector4 result = { 0 };
...
RMAPI Matrix MatrixPerspective(double fovy, double aspect, double near, double far)
{
    ...
    double top = near*tan((float)(fovy*0.5));
    double bottom = -top;
...
RMAPI Quaternion QuaternionFromMatrix(Matrix mat)
{
    ...
    {
        float s = sqrt(1.0f + mat.m0 - mat.m5 - mat.m10)*2;
    ...
    {
        float s = sqrt(1.0f + mat.m5 - mat.m0 - mat.m10)*2;
    ...
    {
        float s = sqrt(1.0f + mat.m10 - mat.m0 - mat.m5)*2;
